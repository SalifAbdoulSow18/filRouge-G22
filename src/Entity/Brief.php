 ...
 *              "method"="GET",
 *              "path"="formateurs/promo/{id1}/groupe/{id2}/briefs",
 ...
 *          },
 *          "get_brief_assigned_to_one_apprenant"={
 *              "method"="GET",
 *              "path"="apprenants/promo/{id}/briefs",
 *              "route_name"="get_brief_assigned_to_one_apprenant"
 *          },
 *          "get_brief_of_promo"={
 *              "method"="GET",
 *              "path"="formateurs/{id}/briefs/brouillons",
 *              "route_name"="get_brief_of_promo"
 *          },
 *          "get_brief_valide"={
 *              "method"="GET",
 ...
 *          },
 *          "get_brief_of_one_promo"={
 *              "method"="GET",
 *              "path"="formateurs/promo/{id1}/briefs/{id2}",
 *              "route_name"="get_brief_of_one_promo"
 *          }
 *      }
 * )
 */
