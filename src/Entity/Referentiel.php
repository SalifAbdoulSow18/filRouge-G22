...
class Referentiel
{
     ...
     * @Groups({"promo_ref_gpecomp_competence:read","referentiel_gpecompetence:read","prom_ref_app_form", "referentiel_formateur_gpe:read","ref_gpecomp_comp:read","apprenant_id_promo:read","put_ref_promo:read","promo_stat"}) 
     */
    private $id;
