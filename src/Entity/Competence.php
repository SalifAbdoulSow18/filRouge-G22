...
class Competence
{
     ...
     * @Groups({"promo_stat","promo_ref_gpecomp_competence:read","ref_gpecomp_comp:read","gpecompetence_competence_id:read","gpecompetence_competences:read","competenceof_gpecompetence", "competence_niveau:read","apprenant_collection_competence","promo_stat","competence:read"})
     */
    private $id;
     ...
     * @Groups({"competence_niveau:read","competence:read"})
     */
    private $niveaux;
