...
class Niveau
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Brief::class, mappedBy="niveau", cascade={"persist"})
     */
    private $briefs;

    /**
     * @ORM\ManyToMany(targetEntity=LivrablePartiel::class, mappedBy="niveau", cascade={"persist"})
     */
