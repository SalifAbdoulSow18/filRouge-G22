 ...
 */
final class Version20200830170815 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apprenant_livrable_partiel DROP livrable_partiels_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apprenant_livrable_partiel ADD livrable_partiels_id INT DEFAULT NULL');
